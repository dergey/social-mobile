...
public class LiveDataFutureCallback<T> implements FutureCallback<Result<T, ErrorDto>> {

    private final MutableLiveData<UiResult<T>> provideLiveData;

    public LiveDataFutureCallback(MutableLiveData<UiResult<T>> provideLiveData) {
